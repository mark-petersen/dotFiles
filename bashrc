...
### LANL yellow IC: snow
  ...
  alias jj='cd /users/mpeterse/repos/jayenne/redecomp-output/src/api'
...
# LANL IC
alias tt="scp mpeterse@wtrw.lanl.gov:ch-fe.lanl.gov:/lustre/scratch5/mpeterse/trash/tar.tar .; tar xvf tar.tar; rm -f tar.tar"
