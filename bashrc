...
alias gsuom='git submodule update --init --recursive externals/ekat externals/scorpio cime components/omega/external; echo "git submodule update for omega"'
alias gd="git diff"
...
alias tau='scp mpeterse@aurora.alcf.anl.gov:~/a/tar.tar .;tar xvf tar.tar; rm -f tar.tar'
alias toau='scp ~/a/tar.tar mpeterse@aurora.alcf.anl.gov:~/a/tar.tar'
# PNNL
...
alias chr='ssh -J ac.mpetersen@logins.lcrc.anl.gov ac.mpetersen@chrysalis.lcrc.anl.gov'
